...
if isempty(shim.name)
    ...
    shim.name = 'ECOS';
    shim.dualize = true;
    intname = [int_path, 'ecos', fs, fname];
...
n_out = reord.f.n;
reord.l.c = reord.l.c + n_out;
n_out = n_out + reord.l.n;
reord.a.c = reord.a.c + n_out;
n_out = n_out + reord.a.n;
reord.q.c = reord.q.c + n_out;
n_out = n_out + reord.q.n;
reord = sparse( ...
    [reord.f.r; reord.l.r; reord.a.r; reord.q.r], ...
